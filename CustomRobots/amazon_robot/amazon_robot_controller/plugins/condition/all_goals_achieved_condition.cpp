...
#include "amazon_robot_controller/plugins/condition/all_goals_achieved_condition.hpp"
...
{
  factory.registerNodeType<amazon_robot_controller::AllGoalsAchievedCondition>(
    "AllGoalsAchieved");
}
