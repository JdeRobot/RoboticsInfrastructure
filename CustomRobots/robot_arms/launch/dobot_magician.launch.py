...
def launch_setup(context):
    ...
    xacro_file = os.path.join(
        ...
        "models",
        "dobot_magician",
        "dobot_magician.urdf.xacro",
    )

    controllers_file = os.path.join(
        package_dir, "config", "dobot_magician_controllers.yaml"
    )
    ...
    robot_description_semantic = {
        "robot_description_semantic": load_file(
            "ros2srrc_dobot_magician_moveit2", "config/dobot_magician_gripper.srdf"
        )
    }
    ...
    kinematics_yaml = load_yaml(
        "dobot_magician_gripper_moveit_config", "config/kinematics.yaml"
    )
    ...
    moveit_controllers = load_yaml(
        "dobot_magician_gripper_moveit_config", "config/moveit_controllers.yaml"
    )

    ompl_planning = load_yaml(
        "dobot_magician_gripper_moveit_config", "config/ompl_planning.yaml"
    )
    ...
    pilz_cartesian_limits = load_yaml(
        "ros2srrc_robots", "dobot_magician/config/pilz_cartesian_limits.yaml"
    )

    joint_limits_yaml = load_yaml(
        "ros2srrc_robots", "dobot_magician/config/joint_limits.yaml"
    )
    ...
    move = Node(
        ...
        parameters=[
            ...
            {"use_sim_time": True},
            {"ROB_PARAM": "dobot_magician"},
            {"EE_PARAM": "dobot_gripper"},
            {"ROB_GROUP": "dobot_magician_arm"},
        ],
    )
