# Platform controller for amazon_robot_classic model
...
## STEP BY STEP
- 1. Launch model inside a scenary with any launcher inside `amazon_robot_classic/launch` directory; custom_robots package must be built for launchers to work porperly.
