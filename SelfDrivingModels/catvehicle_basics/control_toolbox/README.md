...
##### _NOTE:_ This is a tweaked version of origin [control_toolbox](https://github.com/ros-controls/control_toolbox) package for the purpose of use in [Cat Vehicle Testbed](https://github.com/jmscslgroup/catvehicle).
