...
EXERCISE = "power_tower_inspection_newmanager"
TIMEOUT = 30
MAX_ATTEMPT = 2
...
class Launch():
    ...
    def start(self):
        ...
        args = ["/opt/ros/noetic/bin/roslaunch",
                "/opt/jderobot/Launchers/power_tower_inspection/gazebo.launch",
                "--wait",
                "--log"
                ]
        ...
        ######## LAUNCH PX4 ########
        args = ["/opt/ros/noetic/bin/roslaunch",
                "/opt/jderobot/Launchers/power_tower_inspection/px4.launch",
                "--log"
                ]
        ...
        ######## LAUNCH MAVROS ########
        args = ["/opt/ros/noetic/bin/roslaunch",
                "/opt/jderobot/power_tower_inspection/mavros.launch",
                "--log"
                ]
