...
def generate_launch_description():
    ...
    start_turtlebot2_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(pkg_share_dir, "launch", "spawn_model.launch.py")
        ),
        launch_arguments={
            "-x": x_turtlebot2_position,
            "-y": y_turtlebot2_position,
            "-z": z_turtlebot2_position,
        }.items(),
    )
