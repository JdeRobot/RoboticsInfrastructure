...
EXERCISE = "drone_gymkhana_newmanager"
TIMEOUT = 30
MAX_ATTEMPT = 2
...
class Launch():
    ...
    def start(self):
        ...
        args = ["/opt/ros/noetic/bin/roslaunch",
                "/opt/jderobot/Launchers/drone_gymkhana/gazebo.launch",
                "--wait",
                "--log"
                ]
        ...
        ######## LAUNCH PX4 ########
        args = ["/opt/ros/noetic/bin/roslaunch",
                "/opt/jderobot/Launchers/drone_gymkhana/px4.launch",
                "--log"
                ]
        ...
        ######## LAUNCH MAVROS ########
        args = ["/opt/ros/noetic/bin/roslaunch",
                "/opt/jderobot/Launchers/drone_gymkhana/mavros.launch",
                "--log"
                ]
