"""Entry point for the Package Delivery exercise."""
...
def generate_launch_description():
    """Generate the launch description for package delivery simulation."""
    ...
    world_path = os.path.join(
        custom_robots_share, "worlds", "package_delivery_harmonic.world"
    )
