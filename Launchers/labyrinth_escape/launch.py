...
EXERCISE = "labyrinth_escape_newmanager"
TIMEOUT = 30
MAX_ATTEMPT = 2
...
class Launch():
    ...
    def start(self):
        ...
        args = ["/opt/ros/noetic/bin/roslaunch",
                "/opt/jderobot/Launchers/labyrinth_escape/gazebo.launch",
                "--wait",
                "--log"
                ]
        ...
        ######## LAUNCH PX4 ########
        args = ["/opt/ros/noetic/bin/roslaunch",
                "/opt/jderobot/Launchers/labyrinth_escape/px4.launch",
                "--log"
                ]
        ...
        ######## LAUNCH MAVROS ########
        args = ["/opt/ros/noetic/bin/roslaunch",
                "/opt/jderobot/Launchers/labyrinth_escape/mavros.launch",
                "--log"
                ]
