"""
Wrapper around the Aerostack2 drone interface for use in Robotics Academy.
...
class DroneWrapper(DroneInterfaceBase):
    ...
    Adds yaw rate subscription, motion commands, and takeoff/land logic.
    """
    ...
    def __init__(self, drone_id: str = "drone0", verbose: bool = False) -> None:
        """
        Initialize the drone wrapper and its subscriptions and clients.

        :param drone_id: ROS namespace / drone identifier (e.g. "drone0").
        :param verbose: Whether to enable verbose logging from the base interface.
        """
...
def main(args=None):
    """Initialize ROS 2, create and spin the drone wrapper node, then shutdown."""
