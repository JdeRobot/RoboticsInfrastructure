...
#    print(f'{os.path.isfile(rviz_config)=}')
    ...
    aerial_platform = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'platform_config_file': sim_config + '/platform_config_file_px4.yaml'
        }.items(),
    )
    state_estimator = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'plugin_config_file': sim_config + '/state_estimator_odom_px4.yaml'
        }.items(),
    )
    motion_controller = IncludeLaunchDescription(
        ...
        launch_arguments={
            'namespace': LaunchConfiguration('namespace'),
            'use_sim_time': 'true',
            'motion_controller_config_file': sim_config + '/motion_controller_px4.yaml',
