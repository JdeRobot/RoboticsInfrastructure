...
import jsSnippets from '../snippets/javascript'
import 'brace-ace/ext/language_tools'
...
export default class ReactAce extends Component {
  ...
  componentDidMount() {
    ...
    if (jsSnippets) {
      snippetManager.files.javascript = jsSnippets;
      snippetManager.register(jsSnippets.snippetText, jsSnippets.scope);
    }
