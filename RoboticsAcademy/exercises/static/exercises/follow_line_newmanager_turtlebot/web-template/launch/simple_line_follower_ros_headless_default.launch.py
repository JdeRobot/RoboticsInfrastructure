...
def generate_launch_description():
  ...
  world_path = "/RoboticsAcademy/exercises/static/exercises/follow_line_newmanager_turtlebot/web-template/launch/prototype_f1_circuit_game_headless_default.world"
