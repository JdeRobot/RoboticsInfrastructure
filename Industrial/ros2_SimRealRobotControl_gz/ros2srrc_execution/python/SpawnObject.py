...
def main():
    ...
    parser.add_argument(
        "--urdf", type=str, default="", help="URDF of the object to spawn."
    )
    parser.add_argument(
        "--name", type=str, default="", help="Name of the object to spawn."
    )
    parser.add_argument(
        "--namespace",
        type=str,
    ...
    parser.add_argument(
        "--ns", type=bool, default=True, help="Whether to enable namespacing"
    )
    parser.add_argument(
        "--x",
        type=float,
    ...
    )  # It is assumed that the .urdf/.xacro file is located in /urdf/objects folder!
    ...
    if args.namespace is True:
        ...
        node.get_logger().info(
            "spawning `{}` at {}, {}, {}".format(args.name, args.x, args.y, args.z)
        )
