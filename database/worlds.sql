...
31	Quadrotor Cat	/home/ws/src/CustomRobots/quadrotor/launch/quadrotor.launch.py	drone	sensor:=camera namespace:=drone color:=Orange scale:=3.0	quadrotor/models/quadrotor/quadrotor.urdf.xacro
32	Quadrotor Mouse	/home/ws/src/CustomRobots/quadrotor/launch/quadrotor.launch.py	drone_mouse	sensor:=camera namespace:=drone_mouse color:=Magenta scale:=3.0	quadrotor/models/quadrotor/quadrotor.urdf.xacro
\.
