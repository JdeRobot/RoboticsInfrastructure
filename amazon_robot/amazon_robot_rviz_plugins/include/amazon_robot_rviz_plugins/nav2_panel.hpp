...
#ifndef AMAZON_ROBOT_RVIZ_PLUGINS__NAV2_PANEL_HPP_
#define AMAZON_ROBOT_RVIZ_PLUGINS__NAV2_PANEL_HPP_
...
#include "amazon_robot_rviz_plugins/ros_action_qevent.hpp"
...
private:
  ...
  using WaypointFollowerGoalHandle =
    rclcpp_action::ClientGoalHandle<amazon_robot_msg::action::FollowTargets>;
  ...
  rclcpp_action::Client<amazon_robot_msg::action::FollowTargets>::SharedPtr
    waypoint_follower_action_client_;

  // Goal-related state
  nav2_msgs::action::NavigateToPose::Goal navigation_goal_;
  amazon_robot_msg::action::FollowTargets::Goal waypoint_follower_goal_;
