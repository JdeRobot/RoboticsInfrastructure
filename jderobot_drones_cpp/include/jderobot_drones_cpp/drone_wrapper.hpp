...
#include <as2_motion_reference_handlers/position_motion_handler.hpp>
#include <as2_motion_reference_handlers/speed_motion_handler.hpp>
...
private:
  ...
  std::shared_ptr<as2::motionReferenceHandlers::PositionMotionHandler> pos_handler_;
  std::shared_ptr<as2::motionReferenceHandlers::SpeedMotionHandler> speed_handler_;
